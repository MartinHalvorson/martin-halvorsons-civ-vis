...
| Districts + adjacency (incl. river) | ✅ | all 19 universal and 16 unique Gathering Storm districts; exact source-by-source adjacency rounding, replacement-family inheritance, placement/cap rules, adjacency policy cards, appeal Housing, Grove/Sanctuary yields on adjacent unimproved Charming/Breathtaking tiles, district/unique Great Person rates, active unique bonuses, and one-time effects including Preserve and Gaul specialty-district Culture Bombs |
